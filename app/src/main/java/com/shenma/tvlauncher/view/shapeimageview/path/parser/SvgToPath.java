package com.shenma.tvlauncher.view.shapeimageview.path.parser;
...
import  com.shenma.tvlauncher.view.shapeimageview.path.parser.PathInfo;
...
public class SvgToPath {
    ...
    public static com.shenma.tvlauncher.view.shapeimageview.path.parser.PathInfo getSVGFromInputStream(InputStream inputStream) {
        return SvgToPath.parse(inputStream, true, DPI);
    }

    private static com.shenma.tvlauncher.view.shapeimageview.path.parser.PathInfo parse(InputStream in, boolean ignoreDefs, float dpi)  {
        try {
            ...
            if (ignoreDefs) {
                ...
                com.shenma.tvlauncher.view.shapeimageview.path.parser.CopyInputStream cin = new com.shenma.tvlauncher.view.shapeimageview.path.parser.CopyInputStream(in);

                XmlPullParser ids = new KXmlParser();
                ids.setInput(new InputStreamReader(cin.getCopy()));
                com.shenma.tvlauncher.view.shapeimageview.path.parser.IdHandler idHandler = new com.shenma.tvlauncher.view.shapeimageview.path.parser.IdHandler(ids);
    ...
    private Path path;
    private com.shenma.tvlauncher.view.shapeimageview.path.parser.PathInfo pathInfo = null;
    ...
    private void pushTransform(XmlPullParser atts) {
        final String transform = com.shenma.tvlauncher.view.shapeimageview.path.parser.ParseUtil.getStringAttr("transform", atts);
        final Matrix matrix = transform == null ? IDENTITY_MATRIX : com.shenma.tvlauncher.view.shapeimageview.path.parser.TransformParser.parseTransform(transform);
    ...
    void startElement() {
        ...
        if (localName.equals("svg")) {
            ...
            com.shenma.tvlauncher.view.shapeimageview.path.parser.NumberParse viewbox = com.shenma.tvlauncher.view.shapeimageview.path.parser.NumberParse.getNumberParseAttr("viewBox", atts);
            ...
            String href = com.shenma.tvlauncher.view.shapeimageview.path.parser.ParseUtil.getStringAttr("xlink:href", atts);
            String attTransform = com.shenma.tvlauncher.view.shapeimageview.path.parser.ParseUtil.getStringAttr("transform", atts);
            String attX = com.shenma.tvlauncher.view.shapeimageview.path.parser.ParseUtil.getStringAttr("x", atts);
            String attY = com.shenma.tvlauncher.view.shapeimageview.path.parser.ParseUtil.getStringAttr("y", atts);
            ...
            if (attTransform != null || attX != null || attY != null) {
                ...
                if (attTransform != null) {
                    sb.append(com.shenma.tvlauncher.view.shapeimageview.path.parser.ParseUtil.escape(attTransform));
                }
                if (attX != null || attY != null) {
                    sb.append("translate(");
                    sb.append(attX != null ? com.shenma.tvlauncher.view.shapeimageview.path.parser.ParseUtil.escape(attX) : "0");
                    sb.append(",");
                    sb.append(attY != null ? com.shenma.tvlauncher.view.shapeimageview.path.parser.ParseUtil.escape(attY) : "0");
                    sb.append(")");
                }
                sb.append("'");
            }
            ...
            for (int i = 0; i < atts.getAttributeCount(); i++) {
                ...
                if (!"x".equals(attrQName) && !"y".equals(attrQName) &&
                    ...
                    sb.append(attrQName);
                    sb.append("='");
                    sb.append(com.shenma.tvlauncher.view.shapeimageview.path.parser.ParseUtil.escape(atts.getAttributeValue(i)));
                    sb.append("'");
                }
            }
            ...
            if ("none".equals(com.shenma.tvlauncher.view.shapeimageview.path.parser.ParseUtil.getStringAttr("display", atts))) {
                if (!hidden) {
                    hidden = true;
                    hiddenLevel = 1;
                }
            ...
            com.shenma.tvlauncher.view.shapeimageview.path.parser.NumberParse numbers = com.shenma.tvlauncher.view.shapeimageview.path.parser.NumberParse.getNumberParseAttr("points", atts);
            if (numbers != null) {
                Path p = new Path();
            ...
            Path p = com.shenma.tvlauncher.view.shapeimageview.path.parser.PathParser.doPath(com.shenma.tvlauncher.view.shapeimageview.path.parser.ParseUtil.getStringAttr("d", atts));
            pushTransform(atts);
            Matrix matrix = popTransform();
            p.transform(matrix);
            path.addPath(p);
    ...
    final Float getFloatAttr(String name, XmlPullParser attributes, Float defaultValue) {
        Float result = com.shenma.tvlauncher.view.shapeimageview.path.parser.ParseUtil.convertUnits(name, attributes, dpi, width, height);
