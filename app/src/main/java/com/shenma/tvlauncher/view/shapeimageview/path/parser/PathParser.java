...
import com.shenma.tvlauncher.view.shapeimageview.path.parser.ParserHelper;
import com.shenma.tvlauncher.view.shapeimageview.path.parser.SvgToPath;
...
class PathParser {
    ...
    public static Path doPath(String s) {
        int n = s.length();
        com.shenma.tvlauncher.view.shapeimageview.path.parser.ParserHelper ph = new com.shenma.tvlauncher.view.shapeimageview.path.parser.ParserHelper(s);
        ph.skipWhitespace();
        Path p = new Path();
        float lastX = 0;
        float lastY = 0;
