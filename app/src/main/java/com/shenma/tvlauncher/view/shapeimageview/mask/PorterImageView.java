package com.shenma.tvlauncher.view.shapeimageview.mask;
...
public abstract class PorterImageView extends ImageView {
    private static final String TAG = com.shenma.tvlauncher.view.shapeimageview.mask.PorterImageView.class.getSimpleName();
