...
public class DatabaseOperator {
    ...
    private boolean queryExistByName(String pkgname) {
        if (!"".equals(pkgname)) {
            ...
            Cursor c = db.query("DatabaseHelper.TABLE_APPLOVES", null, "packagename=?", new String[]{pkgname}, null, null, null);
            if (c.moveToNext()) {
    ...
    public void deleteApp(String packName) {
        SQLiteDatabase db = databaseHelper.getWritableDatabase();
        db.delete("DatabaseHelper.TABLE_APPLOVES", "packagename=?", new String[]{packName});
        db.close();
    }
    ...
    public List<String> queryAll() {
        ...
        SQLiteDatabase db = databaseHelper.getReadableDatabase();
        Cursor c = db.query("DatabaseHelper.TABLE_APPLOVES", null, null, null, null, null, null);
        while (c.moveToNext()) {
