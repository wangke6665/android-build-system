...
public class Settings {
    ...
    public static final int PV_PLAYER__IjkAliMediaPlayer = 4;
    ...
    public int getPlayer() {
        ...
        try {
            ...
            // 从 VideoDetailsActivity 获取当前播放器内核设置
            // nhposition: 0=自动, 1=系统, 2=IJK, 3=EXO, 4=阿里
            return VideoDetailsActivity.nhposition;
        }
    }

    public boolean getUsingMediaCodec() {
        String key = mAppContext.getString(R.string.pref_key_using_media_codec);
        //System.out.println("解码：" + mSharedPreferences.getBoolean(key, true));
        return mSharedPreferences.getBoolean(key, false);
    }
