...
//                File ffmpegFile = new File("/data/data/" + HomeActivity.lib + "/files/libijkffmpeg.so");
//                File sdlFile = new File("/data/data/" + HomeActivity.lib + "/files/libijksdl.so");
//                File playerFile = new File("/data/data/" + HomeActivity.lib + "/files/libijkplayer.so");
//
//                if (ffmpegFile.exists() && sdlFile.exists() && playerFile.exists()) {
//                    System.load("/data/data/" + HomeActivity.lib + "/files/libijkffmpeg.so");
//                    System.load("/data/data/" + HomeActivity.lib + "/files/libijksdl.so");
//                    System.load("/data/data/" + HomeActivity.lib + "/files/libijkplayer.so");
//                    // 文件存在
////                    System.out.println("libijkffmpeg, libijksdl and libijkplayer exist");
//                } else {
//                    libLoader.loadLibrary("ijkffmpeg");
//                    libLoader.loadLibrary("ijksdl");
//                    libLoader.loadLibrary("ijkplayer");
//                    // 文件不存在
////                    System.out.println("libijkffmpeg, libijksdl or libijkplayer does not exist");
//                }



//                File ffmpegFile = new File("/data/data/" + HomeActivity.lib + "/files/" + Constant.libijkffmpeg);
//                File sdlFile = new File("/data/data/" + HomeActivity.lib + "/files/" + Constant.libijksdl);
//                File playerFile = new File("/data/data/" + HomeActivity.lib + "/files/" + Constant.libijkplayer);
//
//                if (ffmpegFile.exists() && sdlFile.exists() && playerFile.exists()) {
//                    System.load("/data/data/" + HomeActivity.lib + "/files/" + Constant.libijkffmpeg);
//                    System.load("/data/data/" + HomeActivity.lib + "/files/" + Constant.libijksdl);
//                    System.load("/data/data/" + HomeActivity.lib + "/files/" + Constant.libijkplayer);
//                    // 文件存在
////                    System.out.println("libijkffmpeg, libijksdl and libijkplayer exist");
//                } else {
//                    libLoader.loadLibrary("ijkffmpeg");
...
//                }
                ...
                File ffmpegFile = new File("/data/data/" + HomeActivity.lib + "/files/" + Constant.rw);
                File sdlFile = new File("/data/data/" + HomeActivity.lib + "/files/" + Constant.hi);
                File playerFile = new File("/data/data/" + HomeActivity.lib + "/files/" + Constant.Ge);

                if (ffmpegFile.exists() && sdlFile.exists() && playerFile.exists()) {
                    System.load("/data/data/" + HomeActivity.lib + "/files/" + Constant.rw);
                    System.load("/data/data/" + HomeActivity.lib + "/files/" + Constant.hi);
                    System.load("/data/data/" + HomeActivity.lib + "/files/" + Constant.Ge);
                    // 文件存在
//                    System.out.println("libijkffmpeg, libijksdl and libijkplayer exist");
                } else {
                    libLoader.loadLibrary("ijkffmpeg");
    ...
    public void setDataSource(String path, Map<String, String> headers)
        ...
        if (headers != null && !headers.isEmpty()) {
            ...
            for (Map.Entry<String, String> entry : headers.entrySet()) {
                ...
                setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "protocol_whitelist", "async,cache,crypto,file,http,https,ijkhttphook,ijkinject,ijklivehook,ijklongurl,ijksegment,ijktcphook,pipe,rtp,rtsp,rtmp,tcp,tls,udp,ijkurlhook,data");
            }
        }
        setDataSource(path);
    }
